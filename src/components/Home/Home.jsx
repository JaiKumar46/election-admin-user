...
const Home = () => {
  return (
    <div className=' bg-black h-1/2 w-1/2  rounded-2xl absolute top-40 left-[20rem] flex align-middle justify-evenly shadow-xl shadow-amber-400'>
        ...
        <button className='bg-green-600 h-[3.5rem] p-1 w-[10rem] relative top-[10rem] rounded-md right-[7rem] hover:bg-white hover:border-4 hover:border-green-600 '><Link to="/userlogin" className='text-center text-[2rem] ahover font-bold decoration-transparent'>User</Link></button>
    </div>
  )
}
